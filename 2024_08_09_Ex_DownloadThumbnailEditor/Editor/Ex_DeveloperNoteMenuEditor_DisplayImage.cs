...
public class Ex_DeveloperNoteMenuEditor_DisplayImage  : EditorWindow
{
    ...
    {
        Ex_DeveloperNoteMenuEditor_DisplayImage window = (Ex_DeveloperNoteMenuEditor_DisplayImage)EditorWindow.GetWindow(typeof(Ex_DeveloperNoteMenuEditor_DisplayImage));
